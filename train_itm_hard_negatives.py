...
def main(opts):
    ...
    LOGGER.info("  Num examples = %d", sum(all_gather_list(len(train_dataset_t))))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=511,
        type=int,
        help="Number of negative samples per positive sample" "(forward only)",
    )
    parser.add_argument(
        "--hard_neg_size",
        default=31,
