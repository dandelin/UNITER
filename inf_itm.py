...
def evaluate(model, eval_loader):
    ...
    eval_log = itm_eval(
        all_score, all_txt_ids, all_img_ids, dset.txt2img, dset.img2txts
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint", default=None, type=str, help="model checkpoint binary"
    )
    parser.add_argument(
        "--model_config", default=None, type=str, help="model config json"
    )
    parser.add_argument(
        "--output_dir",
        default=None,
    ...
    parser.add_argument(
        "--batch_size", default=400, type=int, help="number of tokens in a batch"
    )
